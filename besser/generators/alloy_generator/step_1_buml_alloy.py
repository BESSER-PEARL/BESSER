...
def generate_alloy(input_model: str) -> bool:
    ...
    if not model_path.exists():
        print(f"✗ File not found: {input_model}")
        return False
    ...
    # Search .als generated by BESSER
...
def _find_als(model_dir: Path, model_name: str) -> Path | None:
    ...
    # Recursive search: the most recent .als within directory
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python buml_to_alloy.py <model.py>")
        sys.exit(1)
