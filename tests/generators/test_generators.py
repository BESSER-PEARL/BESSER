from core.structural.rules import OCLExpression, PropertyCallExpression, IntegerLiteralExpression, \
    OperationCallExpression, OCLConstraint
from core.structural.structural import DomainModel, Class, Property, PrimitiveDataType, Multiplicity, Constraint
...
def test_django_generator_rule_based_model_with_just_classes():
    ...
    attribute2: Property = Property(name="attribute2", owner=None, type=PrimitiveDataType("int"),
                                    multiplicity=Multiplicity(1, 1))
...
def test_django_generator_rule_based_model_with_validators():
    ...
    attribute3: Property = Property(name="attribute3", owner=None, type=PrimitiveDataType("int"),
                                    multiplicity=Multiplicity(1, 1))
...
def test_django_generator_llm_based():
    model = DomainModel(name="test_model", types=None, associations=None, packages=None, constraints=None)
    class1: Class
    attribute1: Property = Property(name="id", owner=None, type=PrimitiveDataType("int"),
                                    multiplicity=Multiplicity(1, 1))
    attribute2: Property = Property(name="name", owner=None, type=PrimitiveDataType("str"),
                                    multiplicity=Multiplicity(1, 1))
