...
* :doc:`../buml_language/model_types/knowledge_graph`
...
+-----------------------------------------------------------------------------+------------+--------+-----+-----+------------+---------------+-------+----------------+------+-----------------+
| Notation                                                                    | Structural | Object | GUI | OCL | Deployment | State Machine | Agent | Neural Network | BPMN | Knowledge Graph |
+=============================================================================+============+========+=====+=====+============+===============+=======+================+======+=================+
| :doc:`Web Modeling Editor <./web_editor>`                                   |     X      |   X    |  X  |     |            |       X       |   X   |       X        |  X   |        X        |
+-----------------------------------------------------------------------------+------------+--------+-----+-----+------------+---------------+-------+----------------+------+-----------------+
| :doc:`B-UML python library <buml_language/model_building/buml_core>`        |     X      |   X    |  X  |  X  |     X      |       X       |   X   |       X        |  X   |        X        |
+-----------------------------------------------------------------------------+------------+--------+-----+-----+------------+---------------+-------+----------------+------+-----------------+
...
+-----------------------------------------------------------------------------+------------+--------+-----+-----+------------+---------------+-------+----------------+------+-----------------+
| :doc:`Ontology import <buml_language/model_building/kg_to_buml>`            |     X      |        |     |  X  |            |               |       |                |      |        X        |
+-----------------------------------------------------------------------------+------------+--------+-----+-----+------------+---------------+-------+----------------+------+-----------------+
