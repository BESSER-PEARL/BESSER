...
class Person(Base):
    ...
    phoneNumber: Mapped_[str] = mapped_column(String_(100))
    emailAddress: Mapped_[str] = mapped_column(String_(100))
...
class BookingRoom(Base):
    ...
    extraCharges: Mapped_[float] = mapped_column(Float_, default=0.0)
...
class Room(Base):
    ...
    standardNightlyPrice: Mapped_[float] = mapped_column(Float_)
...
#--- Relationships of the bookingroom table

BookingRoom.booking: Mapped_["Booking"] = relationship("Booking", back_populates="bookingRooms", uselist=False, foreign_keys=[BookingRoom.booking_id])

BookingRoom.room: Mapped_["Room"] = relationship("Room", back_populates="bookingroom", uselist=False, foreign_keys=[BookingRoom.room_id])
...
Booking.bookingRooms: Mapped_[List_["BookingRoom"]] = relationship("BookingRoom", back_populates="booking", foreign_keys=[BookingRoom.booking_id])

#--- Relationships of the room table
Room.bookingroom: Mapped_[List_["BookingRoom"]] = relationship("BookingRoom", back_populates="room", foreign_keys=[BookingRoom.room_id])
