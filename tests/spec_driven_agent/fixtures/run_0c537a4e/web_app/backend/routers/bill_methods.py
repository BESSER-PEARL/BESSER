...
async def bill_registerPayment(
    ...
    try:
        ...
        # Bill.registerPayment: no body in the model - be honest: 501, never a fake "executed" success.
        sys.stdout = sys.__stdout__
        raise HTTPException(
            status_code=501,
            detail="Method 'registerPayment' of Bill is modeled but has no implementation",
        )
