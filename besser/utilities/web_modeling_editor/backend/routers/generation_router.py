...
async def generate_code_output_from_project(input_data: ProjectInput):
    ...
    # PyTorch/TensorFlow → neural network, BPMN → business process). The required
    # diagram type comes from the registry, so this branch covers every such
    # generator without name-literal switches.
