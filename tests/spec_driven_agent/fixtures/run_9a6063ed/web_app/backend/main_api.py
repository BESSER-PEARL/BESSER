...
from routers import bookedroom as bookedroom_router
...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {"name": "BookedRoom", "description": "Operations for BookedRoom entities"},
        {"name": "BookedRoom Relationships", "description": "Manage BookedRoom relationships"},
...
app.include_router(bookedroom_router.router)
...
def get_statistics(database: Session = Depends(get_db)):
    ...
    stats["bookedroom_count"] = database.query(BookedRoom).count()
