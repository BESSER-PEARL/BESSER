...
from metamodel.structural.structural import DomainModel, Class, Property, DataType, Multiplicity, Constraint
...
def test_django_generator_rule_based_model_with_just_classes():
    ...
    class1: Class
    attribute1: Property = Property(name="attribute1", owner=None, property_type=DataType("int"),
                                    multiplicity=Multiplicity(1, 1))
    attribute2: Property = Property(name="attribute2", owner=None, property_type=DataType("int"),
                                    multiplicity=Multiplicity(1, 1))
...
def test_django_generator_rule_based_model_with_validators():
    ...
    attribute3: Property = Property(name="attribute3", owner=None, property_type=DataType("int"),
                                    multiplicity=Multiplicity(1, 1))
...
def test_django_generator_llm_based():
    model = DomainModel(name="test_model", types=None, associations=None, packages=None, constraints=None)
    class1: Class
    attribute1: Property = Property(name="id", owner=None, property_type=DataType("int"),
                                    multiplicity=Multiplicity(1, 1))
    attribute2: Property = Property(name="name", owner=None, property_type=DataType("str"),
                                    multiplicity=Multiplicity(1, 1))
