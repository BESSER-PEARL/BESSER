...
from besser.BUML.notations.mockup_to_buml.besser_integration.one_page.plantuml_generation import run_pipeline_plantuml_generation
...
def mockup_to_buml(mockup_image_path: str):
    """
