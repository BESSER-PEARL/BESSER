...
class PythonTestCaseGenerator(GeneratorInterface):
    """
    ...
    def generate(self):
        ...
        """
        file_path = self.build_generation_path(file_name="tests.py")
        ...
        with open(file_path, mode="w") as f:
            ...
            print("Tests generated in the location: " + file_path)