# Mutant Operator: Updated Operation Signature: __init__
...
class Reservation:
    ...
    def __init__(self_m, reservationId_m: str, checkInDate_m: str, checkOutDate_m: str, totalCost_m: float, guest_m: 'Guest'=None, room_m: 'Room'=None):
...
class Guest:
    ...
    def loyaltyPoints(self, loyaltyPoints: int):
