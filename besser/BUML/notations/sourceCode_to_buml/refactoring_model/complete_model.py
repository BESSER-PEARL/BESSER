...
class CompeletedCodeGenerator(GeneratorInterface):
    """
    CompeletedCodeGenerator is a class that implements the GeneratorInterface and is responsible for generating
    ...
    def __init__(self, output_dir: str = None, output_file_name: str = None, structure_file_path: str = None,
                 code_file: str = None, keyworld: str=None):
    ...
    def generate(self):
        """
        Generates GUI code based on provided python code and
        saves it to the specified output directory.
        If the output directory was not specified,
        the code generated will be stored
        in the <current directory>/output folder.
        ...
        with open(file_path, mode="w", encoding="utf-8") as f:
            ...
            print("GUI model generated in the location: " + file_path)
