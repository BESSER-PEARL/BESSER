...
nn_model: NN = NN(name="my_model") \
               .add_layer(LinearLayer(name="l1", actv_func="relu",  in_features=13, out_features=64)) \
               .add_layer(LinearLayer(name="l2", actv_func="relu",  in_features=64, out_features=128)) \
               .add_layer(DropoutLayer(name="l3", rate=0.2)) \
               .add_layer(LinearLayer(name="l4", actv_func=None, in_features=128, out_features=1)) \
               .add_parameters(Parameters(batch_size=6, epochs=20, learning_rate=0.01, optimizer="adam", loss_function="mse", 
