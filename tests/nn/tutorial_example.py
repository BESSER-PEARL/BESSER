...
pytorch_model = PytorchGenerator(model=nn_model, output_dir="output/tutorial_example")
pytorch_model.generate() 
tf_model = TFGenerator(model=nn_model, output_dir="output/tutorial_example")
tf_model.generate() 
