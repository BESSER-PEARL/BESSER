...
def run_pipeline_plantuml_generation(mockup_images_path: str, additional_text_file_path: str=None):
    ...
    plantuml_code = direct_prompting_image_to_plantuml(api_key, mockup_images_path, additional_text_file_path, plantuml_code_example_path)
