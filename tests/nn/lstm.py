...
lstm_model.add_layer(LSTMLayer(name="l2", actv_func=None, input_size=326, hidden_size=40, bidirectional=True, dropout=0.5, return_sequences=True))
lstm_model.add_layer(DropoutLayer(name="l3", rate=0.2))
lstm_model.add_layer(LSTMLayer(name="l4", actv_func=None, input_size=2*40, hidden_size=40, dropout=0.2))
