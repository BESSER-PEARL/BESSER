from core.structural.rules import Constraint, OCLConstraint, OCLExpression, IntegerLiteralExpression, PropertyCallExpression, OperationCallExpression
from core.structural.structural import Class, Property, PrimitiveDataType
...
def test_oclexpression_property_arithmetic_comparison_constraint():
    ...
    propertyA1: Property = Property(name="a1", owner=classA, type=PrimitiveDataType(name="int"))
