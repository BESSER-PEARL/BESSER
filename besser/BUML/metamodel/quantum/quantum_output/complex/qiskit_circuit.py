...
qc.append(XGate().control(1, ctrl_state='1'), [q[1], q[2]])

qc.append(XGate().control(1, ctrl_state='1'), [q[2], q[3]])

qc.append(XGate().control(2, ctrl_state='11'), [q[0], q[1], q[3]])

qc.append(HGate().control(1, ctrl_state='1'), [q[0], q[2]])

qc.append(RYGate(1.57), [q[1]])

qc.append(ZGate().control(1, ctrl_state='0'), [q[3], q[2]])

qc.append(SwapGate(), [q[0], q[3]])
