...
from metamodel.structural.structural import NamedElement, DomainModel, Type, Class, \
    Property, DataType, Multiplicity, Association, BinaryAssociation, Generalization, GeneralizationSet, AssociationClass
...
def test_attribute_initialization():
    class1: Type = Type(name="name1")
    attribute1: Property = Property(name="attribute1", owner = class1, property_type=DataType("int"),
...
def test_attribute_type_and_multiplicity_violation():
    with pytest.raises(ValueError) as excinfo:
        attribute1: Property = Property(name="attribute1", property_type=DataType("int"),
                                        multiplicity=Multiplicity(0, -1))
    ...
    with pytest.raises(ValueError) as excinfo:
        attribute1: Property = Property(name="attribute1", property_type=DataType("invented_type"),
                                        multiplicity=Multiplicity(2, 1))
...
def test_class_initialization():
    ...
    class2: Class
    attribute1: Property = Property(name="attribute1", owner=None, property_type=DataType("int"), multiplicity=Multiplicity(0, 1))
    attribute2: Property = Property(name="attribute2", owner=None, property_type=DataType("int"), multiplicity=Multiplicity(0, 1))
...
def test_duplicated_name_class():
    with pytest.raises(ValueError) as excinfo:
        class1 : Class
        attribute1: Property = Property(name="attribute1", owner=None, property_type=DataType("int"), multiplicity=Multiplicity(0, 1))
        attribute2: Property = Property(name="attribute1", owner=None, property_type=DataType("int"), multiplicity=Multiplicity(0, 1))
