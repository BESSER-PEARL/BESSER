...
based around our BUML language and a number of generators built on top of it. 


You'll find here all the necessary information about the BUML language (to model the problem domain) and the 
