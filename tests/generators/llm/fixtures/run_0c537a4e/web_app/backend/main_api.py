...
from routers import bookingroom as bookingroom_router
...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {"name": "BookingRoom", "description": "Operations for BookingRoom entities"},
        {"name": "BookingRoom Relationships", "description": "Manage BookingRoom relationships"},
...
app.include_router(bookingroom_router.router)
...
def get_statistics(database: Session = Depends(get_db)):
    ...
    stats["bookingroom_count"] = database.query(BookingRoom).count()
