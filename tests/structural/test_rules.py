from besser.BUML.metamodel.structural import Constraint, OCLConstraint, OCLExpression, IntegerLiteralExpression, PropertyCallExpression, OperationCallExpression
from besser.BUML.metamodel.structural import Class, Property, PrimitiveDataType
