...
* Added support for creating and editing GUIs from a no-code visual editor (see
  `GUI modeling <https://besser.readthedocs.io/projects/besser-web-modeling-editor/en/latest/editor/gui_editor.html>`_).
