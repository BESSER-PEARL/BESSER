...
layers_fixed_params = {
    ...
    "AdaptiveAvgPool1d": {"pooling_type": "adaptive_average", "dimension": "1D"},
    "AdaptiveAvgPool2d": {"pooling_type": "adaptive_average", "dimension": "2D"},
    "AdaptiveAvgPool3d": {"pooling_type": "adaptive_average", "dimension": "3D"},
...
lookup_loss_functions = {"CrossEntropyLoss": "crossentropy",
