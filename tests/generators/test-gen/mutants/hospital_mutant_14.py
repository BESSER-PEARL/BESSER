...
class Appointment:
    ...
    def __init__(self_m, appointmentId_m: str, date_m: str, time_m: str, status_m: str, patient_m: 'Patient'=None, doctor_m: 'Doctor'=None):
...
class Doctor:
    ...
    def schedule(self, value):
        old_value = getattr(self, f'_Doctor__schedule', None)
