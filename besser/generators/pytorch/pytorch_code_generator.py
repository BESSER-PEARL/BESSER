...
from besser.BUML.metamodel.nn import NN, TrainingDataset, TestDataset, Layer
from besser.generators import GeneratorInterface
from besser.generators.pytorch.utils import get_layer_notation, get_tensorop_notation, \
     add_notation_to_sub_nn, get_rnn_output_notation
...
class PytorchGenerator(GeneratorInterface):
    ...
    def get_modules_details(self):
        ...
        #modules_details = get_rnn_output_notation(modules_details)
