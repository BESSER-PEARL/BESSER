...
def test_a_frontend_finding_no_longer_suppresses_the_boot_probe(orch, monkeypatch):
    ...
    """
    monkeypatch.setattr(
        "besser.generators.llm.validation.frontend_schema.collect_frontend_schema_issues",
...
def test_a_module_that_cannot_be_imported_still_skips_the_probe(orch, monkeypatch):
    ...
    monkeypatch.setattr(
        "besser.generators.llm.orchestrator._unresolvable_local_imports",
...
def test_compaction_carries_the_checklist_blockers_and_contract(orch, monkeypatch):
    ...
    monkeypatch.setattr("besser.generators.llm.orchestrator.maybe_compact", fake_maybe_compact)
