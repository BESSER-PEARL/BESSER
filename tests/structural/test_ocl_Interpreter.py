import sys
from antlr4 import *
from src.BUML.metamodel.structural.OCLsLexer import OCLsLexer
from src.BUML.metamodel.structural.OCLsParser import OCLsParser
import unittest
...
# from OCLInterp import OCLInterp
    ...
    def test_79(self):
        ...
        tree = parser.oclFile()
    def test_80(self):
        ocl = "context meeting inv:10 <self.start "
        input_stream = InputStream(ocl)
        lexer = OCLsLexer(input_stream)
        stream = CommonTokenStream(lexer)
        parser = OCLsParser(stream)
