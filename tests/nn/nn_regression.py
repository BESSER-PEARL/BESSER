...
nn_model.add_layer(LinearLayer(name="l1", activation_function="relu",  in_features=13, out_features=64))
nn_model.add_layer(LinearLayer(name="l2", activation_function="relu",  in_features=64, out_features=128))
nn_model.add_layer(DropoutLayer(name="l3", rate=0.2))
nn_model.add_layer(LinearLayer(name="l4", activation_function=None, in_features=128, out_features=1))
