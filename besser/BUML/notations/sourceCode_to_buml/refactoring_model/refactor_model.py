...
class RefactoredModelGenerator(GeneratorInterface):
    """
    RefactoredModelGenerator is a class that implements the GeneratorInterface and is responsible for generating
    ...
    def generate(self):
        """
        Generates GUI code based on the provided python code saves
        it to the specified output directory.
        If the output directory was not specified,
        the code generated will be stored in the <current directory>/output folder.
