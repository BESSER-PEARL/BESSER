...
class GitHubService:
    ...
    def push_directory_to_repo(
        ...
        tree_sha = self._create_tree(owner, repo_name, tree_entries, base_tree=base_tree_sha)
...
"""
    ...
    def _create_tree(self, owner: str, repo_name: str, tree: List[Dict[str, Any]], base_tree: Optional[str] = None) -> str:
