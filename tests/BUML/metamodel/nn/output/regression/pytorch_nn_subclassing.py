...
class NeuralNetwork(nn.Module):
    def __init__(self):
        super().__init__()
        self.l1 = nn.Linear(in_features=13, out_features=64, bias=True)
        self.actv_func_relu = nn.ReLU()
        self.l2 = nn.Linear(in_features=64, out_features=128, bias=True)
        self.l3 = nn.Dropout(p=0.2)
        self.l4 = nn.Linear(in_features=128, out_features=1, bias=True)
...
if __name__ == "__main__":
    ...
    # Train the neural network
    train(my_model, train_loader, criterion, optimizer, 40)
