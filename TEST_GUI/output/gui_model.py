...
# Screen: icnh
icnh = Screen(name="icnh", description="Home", is_main_page=True, screen_size="Medium")
...
ie5m = BarChart(name="ie5m", bar_width=30, orientation="vertical", show_grid=True, show_legend=True, show_tooltip=True, stacked=False, animate=True, legend_position="top", grid_color="#e0e0e0", bar_gap=4)
...
ik6k = ViewContainer(name="ik6k", description=" container")
cell = ViewContainer(name="Cell", description=" container")
iuri1 = LineChart(name="iuri1", line_width=2, show_grid=True, show_legend=True, show_tooltip=True, curve_type="monotone", animate=True, legend_position="top", grid_color="#e0e0e0", dot_size=5)
...
cell_2 = ViewContainer(name="Cell_2", description=" container")
i3ja1 = BarChart(name="i3ja1", bar_width=30, orientation="vertical", show_grid=True, show_legend=True, show_tooltip=True, stacked=False, animate=True, legend_position="top", grid_color="#e0e0e0", bar_gap=4)
...
cell_3 = ViewContainer(name="Cell_3", description=" container")
i4yjj = LineChart(name="i4yjj", line_width=2, show_grid=True, show_legend=True, show_tooltip=True, curve_type="monotone", animate=True, legend_position="top", grid_color="#e0e0e0", dot_size=5)
...
ik6k.view_elements = {cell, cell_2, cell_3}
