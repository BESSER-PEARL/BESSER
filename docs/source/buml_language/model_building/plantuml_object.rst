...
Let's see an example with object diagram of the classic `library model <https://besser.readthedocs.io/en/latest/_images/library_uml_model.jpg>`_. The textual object 
