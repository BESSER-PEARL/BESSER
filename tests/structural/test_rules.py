from src.BUML.metamodel.structural import Constraint, OCLConstraint, OCLExpression, IntegerLiteralExpression, PropertyCallExpression, OperationCallExpression
from src.BUML.metamodel.structural import Class, Property, PrimitiveDataType
